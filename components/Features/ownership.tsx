    ...
    return (
      ...
      >
        <div className="flex-1 order-1 md:order-0 ">
          ...
          Understand the true legal standing of the vehicle before you buy. This section of the iVin report helps verify whether the vehicle has a clean title and if there are any hidden issues that could affect ownership.
          </p>
