    ...
    return (
      ...
      >
        ...
        <div className="flex-1">
          ...
          A well-maintained vehicle not only runs better but also holds its value longer. iVin compiles service and safety data from verified sources such as authorized repair shops, dealership service centers, and manufacturer databases, so you know exactly how the car has been treated.
          </p>
